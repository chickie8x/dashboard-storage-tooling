<template>
    <div class="h-screen">
        <div class="flex justify-center items-center h-full relative">
            ...
            <div class="bg-black bg-opacity-50 space-y-6 rounded-md p-4 absolute top-0 left-0 w-full h-full flex flex-col lg:flex-row items-center justify-center lg:space-x-6 lg:space-y-0">
                <button @click="goToDashboard" class="min-w-56 py-2 bg-orange-500 text-white text-2xl font-semibold rounded-md duration-300 hover:bg-orange-400 flex items-center justify-center">
